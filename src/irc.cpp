...
void ThreadIRCSeed2()
{
	...
	int ntimeout = 1000;
        ...
        if (TestNet())
        {
            Send(hSocket, "JOIN #litedogecoinTEST\r");
            Send(hSocket, "WHO #litedogecoinTEST\r");
        } else
        {
	    LogPrintf("JOIN #litedogecoin\n");
            // randomly join #litedogecoin00-#litedogecoin05
            //int channel_number = GetRandInt(5);

            // Channel number is always 0 for initial release
            int channel_number = 0;
            Send(hSocket, strprintf("JOIN #litedogecoin%02d\r", channel_number).c_str());
            Send(hSocket, strprintf("WHO #litedogecoin%02d\r", channel_number).c_str());
        };
