...
#endif
    setObjectName("litedoge");
    setStyleSheet("#litedoge { background-color: qradialgradient(cx: -0.8, cy: 0, fx: -0.8, fy: 0, radius: 1.4, stop: 0 #efefef, stop: 1 #dedede);  }");
    // Accept D&D of URIs
    setAcceptDrops(true);
...
void BitcoinGUI::createActions()
{
    ...
    historyAction = new QAction(QIcon(":/icons/history"), tr("&Many Transactions"), this);
    ...
    masternodeManagerAction->setToolTip(tr("Show Masternodes status and configure your nodes."));
...
void BitcoinGUI::createToolBars()
{
    ...
    menuAction->setToolTip(tr("Access Litedoge Wallet Tabs"));
...
void BitcoinGUI::setNumI2PConnections(int count)
{
    ...
    labelI2PConnections->setToolTip(tr("%n active connection(s) to I2P-Litedoge network", "", count));
}
#endif
